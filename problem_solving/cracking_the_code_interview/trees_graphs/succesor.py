# SUCESSOR: Write an algorithm to find the next nth successor (In order traversal) of a given node in a binary search tree
# you may assume that each node as a link to its parent.
#
# The node with the smallest key greater than the key of input node


import os
import sys# Python program to find the inroder successor in a BST
